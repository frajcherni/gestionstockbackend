...
const Article = new EntitySchema({
    ...
    columns: {
        ...
        pua_ttc: { type: "decimal", precision: 10, scale: 2, nullable: true },
        pua_ht: { type: "decimal", precision: 10, scale: 2, nullable: true },
        puv_ht: { type: "decimal", precision: 10, scale: 2, nullable: true },
        tva: { type: "int", nullable: true },
        puv_ttc: { type: "decimal", precision: 10, scale: 2, nullable: true },
